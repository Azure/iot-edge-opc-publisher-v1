...
### Configuration to publish data changes via configuration file
...
### Configuration to publish events via configuration file
To publish OPC UA events you use the same configuration file as for data changes.
An example for publishing events which are generated by the [SimpleEvents server](https://github.com/OPCFoundation/UA-.NETStandard/tree/master/SampleApplications/Workshop/SimpleEvents/Server), which can be found in the [OPC Foundation repository](https://github.com/OPCFoundation/UA-.NETStandard)
is:
