...
The simplest way to configure OPC Publisher is via a configuration file. An example configuration file is provided via the file [`publishednodes.json`](https://github.com/Azure/iot-edge-opc-publisher/blob/main/opcpublisher/publishednodes.json) in this repository.
