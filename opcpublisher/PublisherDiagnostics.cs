        ...
        public async Task ShowDiagnosticsInfoAsync(CancellationToken ct)
        {
            while (true)
            {
                ...
                try
                {
                    ...
                    Logger.Information($"OPC DataChange monitored items (configured/monitored/to remove): {diagnosticInfo.NumberOfOpcDataChangeMonitoredItemsConfigured}/{diagnosticInfo.NumberOfOpcDataChangeMonitoredItemsMonitored}/{diagnosticInfo.NumberOfOpcDataChangeMonitoredItemsToRemove}");
                    Logger.Information($"OPC Event monitored items (configured/monitored/to remove): {diagnosticInfo.NumberOfOpcEventMonitoredItemsConfigured}/{diagnosticInfo.NumberOfOpcEventMonitoredItemsMonitored}/{diagnosticInfo.NumberOfOpcEventMonitoredItemsToRemove}");
                    Logger.Information("---------------------------------");
                    ...
                    Logger.Information($"number of DataChange telemetry events: {diagnosticInfo.NumberOfDataChangeEvents}");
                    Logger.Information($"number of Event telemetry events: {diagnosticInfo.NumberOfEvents}");
                    Logger.Information("---------------------------------");
